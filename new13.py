...
while True:
    ...
    for i, img_with_makeup in enumerate(imgs_with_makeup):
        ...
        if i == best_suggestion_idx:
            ...
            # Save the best suggestion
            output_path = os.path.join(output_dir, f"best_look_{i + 1}.jpg")
            cv2.imwrite(output_path, img_with_makeup)
            print(f"Saved best look to {output_path}")
